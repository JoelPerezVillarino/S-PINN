...
class ImplicitEuler(ThetaMethod):
    ...
    def __init__(
        ...
        super().__init__(1., htau, dim, A, build_boundary_conditions, build_right_hand)
        
    def __call__(self, uSol: np.ndarray, tau: float) -> np.ndarray:
        return super().__call__(uSol, tau)


class FixedPointImplicitEuler(FixedPointThetaMethod):
    ...
    def __init__(
        ...
        super().__init__(
            1., htau, dim, A, build_boundary_conditions, build_right_hand, build_nl_right_hand, source
        )
